...
import dev.aatwi.fmt.services.account.management.services.LoginService;
...
public class LoginControllerTest {
    ...
    it_should_return_NotFound_if_user_is_not_in_the_repository() throws Exception {
        when(loginService.login("email@email.com", "testPassword")).thenReturn(UserBuilder.newNullUser());
    ...
    it_should_return_NotFound_when_password_is_wrong() throws Exception {
        when(loginService.login("john@email.com", "JohnPassword")).thenReturn(UserBuilder.newNullUser());
